    ...
    <motion.div
      ...
      <motion.div
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6 gap-6">
          ...
          <div
            className={`${attendanceStatus.color} bg-slate-800/50 px-6 py-4 rounded-xl border border-slate-600/30 text-center`}>
            <div className="text-2xl font-bold">
              {attendance.attendanceRate}%
            </div>
            <div className="text-sm text-slate-300">Attendance Rate</div>
            <div className={`text-xs mt-1 ${attendanceStatus.color}`}>
          ...
          <motion.div
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-3">
                ...
                <span className={`font-bold ${attendanceStatus.color}`}>
                  {attendance.attendanceRate}%
                </span>
              </div>
