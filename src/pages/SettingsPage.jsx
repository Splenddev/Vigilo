    ...
    <motion.div
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-t-primary mb-2 flex items-center justify-between">
          Settings
          <FiHome onClick={() => navigate(`/${user.role}`)} />
        </h2>
      </div>
    ...
    <div className="glass">
      <div className="flex h-[100dvh] overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Mobile Header */}
          <div className="lg:hidden flex items-center justify-between p-4 bg-bg-glass-sm backdrop-blur-xl border-b border-white/10">
            <button
